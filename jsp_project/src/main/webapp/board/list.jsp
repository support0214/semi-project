...
<div class="container">
	<div>
		<a href="../index.jsp">Team.Arete
	</div>
	<div>
		<a href="../intro/intro.jsp">팀소개</a>
	</div>
	<div>
...
<body>
	...
	<table class="table">
		<thead>
			<tr>
				<td colspan="5">Total : <%=totalRecord%>Articles(<%=nowPage%>
					/ <%=totalPage%>)Page
				</td>
			</tr>
 ...
 for (; pageStart < pageEnd; pageStart++) {
 %> <a href="javascript:paging('<%=pageStart%>')">[<%=pageStart%>]
				</a> <%
 }
 if (totalBlock > nowBlock) {
 %> <a href="javascript:block('<%=nowBlock + 1%>')">...next</a> <%
 ...
 %>
				...
				<td style="text-align: right;" colspan="3"><a href="post.jsp">[글쓰기]</a>&nbsp;
					<a href="javascript:list()">[처음으로]</a> <a href="../index.jsp">[홈으로]</a>
				</td>
			</tr>
		...
		<table align="center" width="800">
			<tr>
				<td align="center"><select name="keyField">
						...
						<option value="subject">제목</option>
						<option value="content">내용</option>
				</select> <input name="keyWord" required> <input type="submit"
					value="찾기"> <input type="hidden" name="nowPage" value="1">
				</td>
			</tr>
		</table>
	</form>

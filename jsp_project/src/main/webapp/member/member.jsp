...
<!--                             
                    ...
                    <div class="button-container">
    					<li>
        				     <input type="button" value="회원가입" onclick="inputCheck();" class="signup-button">
       						 <input type="reset" value="다시쓰기" class="signup-button">
       						 <input type="button" value="로그인" onclick="location.href='login.jsp'" class="login-button">
    					</li>
					</div>
                </ul>
            </section>

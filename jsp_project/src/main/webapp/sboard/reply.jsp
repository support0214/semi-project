...
<body>
	...
	if (id != null) {
	%>
	<form method="post" name="sboardReply" action="sboardReply">
		<table align="center">
			<tr>
				<td align="left">이름</td>
			</tr>	
			...
			<tr>
				<td><input name="subject" size="48"
					placeholder="'<%=bean.getSubject()%>'의 댓글작성"></td>
			</tr>
			<tr>
				<td align="left">내용</td>
				</tr>
			...
			<tr>
				...
				<tr>
				<td><input type="password" name="pass" size="13" required
				placeholder="해당 ID의 비밀번호 입력"></td>
			</tr>
		...
		<!-- 부모글의 정보 -->
		<input type="hidden" name="ref" value="<%=bean.getRef()%>"> <input
